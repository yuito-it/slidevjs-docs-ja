...
<template>
  <Layout>
    <template #nav-bar-title-after>
      <a @click.prevent>
        <Dropdown
          ...
          popper-class="z-1000"
        >
          <Badge class="scale-80 translate-x--1 select-none"> New Docs! </Badge>
          <template #popper>
            <div class="p3 text-sm">
              <p>You are viewing the new Slidev documentation.</p>
              <p>
                The old one is available
                <a
                  href="https://docs-legacy.sli.dev/"
    ...
    <template #sidebar-nav-after>
      <div flex="~ col gap-2">
        <div
          v-if="route.data?.frontmatter?.tags"
        ...
        <div
          v-if="route.data?.frontmatter?.since"
